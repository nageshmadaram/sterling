...
.kite-pcr .kp-tile-side{display:flex;flex-direction:column;justify-content:space-between;align-items:flex-end;text-align:right;gap:4px;min-width:0;flex:1;padding:1px 0}
.kite-pcr .kp-tile-action{font-size:18px;font-weight:750;letter-spacing:.01em;line-height:1.2;white-space:nowrap;text-align:right}
...
.kite-pcr .kp-tile-stamp{font-size:14px;line-height:1.2;white-space:nowrap;font-variant-numeric:tabular-nums;display:flex;align-items:baseline;justify-content:flex-end;gap:2px;overflow:hidden;text-overflow:ellipsis;width:100%;text-align:right}
