...
.kite-pcr .kp-sheet-heat,.kite-pcr .kp-sheet-tape{max-height:calc(100vh - 280px);overflow:auto !important;border-radius:0;background:var(--k-surface)}
...
.kite-pcr .kp-tape-table{width:100%;border-collapse:collapse;background:var(--k-surface)}
...
.kite-pcr .kp-tape-table tbody tr{background:var(--k-surface)}
...
.kite-pcr .kp-tape-row td{padding:6px 10px;border-bottom:1px solid var(--k-border);vertical-align:top;font-size:11.5px;line-height:1.3;text-align:left;background:var(--k-surface)}
...
.kite-pcr .kp-notes{display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:10px;margin-top:16px;clear:both}
...
.kite-pcr .kp-tile-hero{display:flex;align-items:stretch;justify-content:space-between;gap:12px;margin:2px 0 4px}
...
.kite-pcr .kp-tile-side{display:flex;flex-direction:column;justify-content:space-between;align-items:flex-start;text-align:left;gap:4px;min-width:0;margin-left:auto;padding:1px 0}
.kite-pcr .kp-tile-action{font-size:18px;font-weight:750;letter-spacing:.01em;line-height:1.2;white-space:nowrap;text-align:left}
...
.kite-pcr .kp-tile-stamp{font-size:14px;line-height:1.2;white-space:nowrap;font-variant-numeric:tabular-nums;display:flex;align-items:baseline;justify-content:flex-start;gap:2px;overflow:hidden;text-overflow:ellipsis;text-align:left}
